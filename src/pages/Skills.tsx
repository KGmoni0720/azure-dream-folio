  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Online Selling", level: 78 },
        { name: "Content Strategy", level: 75 },
        { name: "Digital Analytics", level: 72 },
      ],
    ...
    },
    {
      ...
      skills: [
        { name: "Cyber Security Basics", level: 82 },
        { name: "IoT Network Design", level: 85 },
        { name: "RFID Technology", level: 88 },
        { name: "Water Management Systems", level: 90 },
      ],
